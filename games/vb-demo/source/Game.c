...
GameState game(void)
{
	...
	// LWX VB Demo: jump straight into the playable demo state, skipping the
	// VUEngine splash/precaution/language chain so the demo is visible
	// immediately (the splash chain above is left wired up but unused).
