...
//   4. Fires the gun via window.__gunFire, which injects a fake XR controller
...
try {
  ...
  ok('off-screen (reload) gun fire does not throw', fireOffScreen.ok, fireOffScreen.reason || `result=${fireOffScreen.result}`);
  await sleep(300);
