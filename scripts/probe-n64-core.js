...
const REQUIRED = [
  ...
  'public/roms/freeware/lwx-n64-smoke.z64',
];
...
try {
  ...
  const result = await page.evaluate((options) => globalThis.runN64CoreE2E(options), {
    ...
    contentUrl: `${origin}/public/roms/freeware/lwx-n64-smoke.z64`,
  ...
  assert.ok(result.video.lit > 0, 'real N64 core output remained blank');
